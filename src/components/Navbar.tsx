    ...
    <header className="sticky top-0 z-50 bg-[#111922] text-[#e9c78a] border-b border-[#d9b8801a] h-[72px] md:h-[89px]">
      <div className="mx-auto flex h-full w-full max-w-7xl items-center justify-between px-4 md:px-6">
        ...
        <a href="/" className="flex items-center h-full">
          <img src="/images/logoo.png" alt="Logo" className="h-10 md:h-[72px] w-auto" />
        </a>
        ...
        <div className="flex items-center gap-4 md:gap-8">
          ...
          <div className="flex items-center gap-5">
            {/* Axtarış */}
            <button aria-label="Search" className="p-1 hover:opacity-90" title="Search">
            ...
            {/* Səbət */}
            <button aria-label="Cart" className="p-1 hover:opacity-90" title="Cart">
      ...
      {/* Mobil menyu */}
      <div className={`md:hidden border-t border-[#d9b8801a] bg-[#0e151d] transition-[max-height] duration-300 ${open ? "max-h-96" : "max-h-0 overflow-hidden"}`}>

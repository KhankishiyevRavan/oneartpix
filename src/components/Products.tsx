        ...
        {products.map((product) => (
          ...
          >
            ...
            <div className="flex flex-col gap-[20px] p-[16px_25px_25px]">
              ...
              <button className="bg-[#171717] border border-[rgba(139,139,139,0.11)] rounded-[9px] p-[15px] flex justify-center items-center gap-[11px] text-[#d1d5db] text-[18px] font-medium leading-none hover:bg-[#2a2a2a] transition-colors">
                <svg
                  width="26"
                  height="26"
                  viewBox="0 0 24 24"

export default function Footer() {
  return (
    <footer className="bg-[#171717] text-[#a3a3a3] py-[54px] font-inter text-[16px] font-normal leading-[1.7]">
      <div className="max-w-[1268px] mx-auto px-5 flex justify-between items-center flex-wrap gap-[30px] max-[1100px]:flex-col max-[1100px]:items-start max-[1100px]:gap-[40px] max-[1100px]:px-[40px] max-[768px]:items-center max-[768px]:text-center">
        {/* Logo & Tagline */}
        <div className="min-w-[350px] max-[768px]:text-center">
